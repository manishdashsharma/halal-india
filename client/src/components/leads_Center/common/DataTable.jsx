                ...
                <thead>
                    <tr className=" bg-gray-50">
                        {columns.map((col) => (
                            <th
                                key={col.key}
                                className={`py-3 px-4 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider border-b border-gray-200 ${col.headerClassName || ''}`}
    ...
    return (
        <>
            <tr className="hover:bg-gray-50">
                ...
                {item.type === 'New Lead' && (
                    <td className="py-3 px-4 border-b border-gray-200 align-middle text-sm whitespace-nowrap">{item.inquiredFor}</td>
                )}
                ...
                <td className="py-3 px-4 border-b border-gray-200 align-middle text-sm whitespace-nowrap text-right">
                    <button
                        className="py-1.5 px-3 border border-gray-300 bg-white text-gray-700 rounded-md text-sm ml-2 hover:bg-gray-50 inline-flex items-center"
                    ...
                    {item.type === 'New Lead' ? (
                        ...
                        <button
                            className="py-1.5 px-3 border border-gray-300 bg-white text-gray-700 rounded-md text-sm ml-2 hover:bg-gray-50 inline-flex items-center"
                            onClick={() => handleViewApprovalDashboard(item)}>
...
export const ApprovedDataRow = ({ item }) => {
    ...
    return (
        <tr className="hover:bg-gray-50">
            ...
            <td className="py-3 px-4 border-b border-gray-200 align-middle text-sm whitespace-nowrap">{item.mobile}</td>
            <td className="py-3 px-4 border-b border-gray-200 align-middle text-sm whitespace-nowrap">
                <span className={`font-semibold py-1 px-2 rounded text-sm inline-block ${statusClasses}`}>{item.status}</span>
            </td>
            <td className="py-3 px-4 border-b border-gray-200 align-middle text-sm whitespace-nowrap text-right">
                <button
                    className="py-1.5 px-3 border border-gray-300 bg-white text-gray-700 rounded-md text-sm ml-2 hover:bg-gray-50 inline-flex items-center"
...
export const AllocatedDataRow = ({ item }) => {
    ...
    const statusClasses =
        item.status === 'In Progress'
            ...
            : item.status === 'Completed'
              ...
              : item.status === 'Pending'
                ? 'text-blue-800 bg-blue-100' // Example for Pending
    ...
    return (
        <tr className="hover:bg-gray-50">
            ...
            <td className="py-3 px-4 border-b border-gray-200 align-middle text-sm whitespace-nowrap">{item.mobile}</td>
            <td className="py-3 px-4 border-b border-gray-200 align-middle text-sm whitespace-nowrap">
                <span className={`font-semibold py-1 px-2 rounded text-sm inline-block ${statusClasses}`}>{item.status || 'N/A'}</span>
            </td>
            <td className="py-3 px-4 border-b border-gray-200 align-middle text-sm whitespace-nowrap text-right">
                <button
                    className="py-1.5 px-3 border border-gray-300 bg-white text-gray-700 rounded-md text-sm ml-2 hover:bg-gray-50 inline-flex items-center"
                ...
                <button
                    className="py-1.5 px-3 border border-gray-300 bg-white text-gray-700 rounded-md text-sm ml-2 hover:bg-gray-50 inline-flex items-center"
                    onClick={() => handleGoToDashboard(item.id)}>
                    <FaExternalLinkAlt className="mr-1.5" /> Go to dashboard
                </button>
            </td>
        </tr>
